...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-crm-white-label?sort=semver)](https://github.com/liberusoftware/module-crm-white-label/releases/latest) [![Tests](https://github.com/liberusoftware/module-crm-white-label/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-crm-white-label/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-crm-white-label
```
...
<a href="https://github.com/liberusoftware/module-crm-white-label/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-crm-white-label" alt="Contributors to liberusoftware/module-crm-white-label">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-crm-white-label/graphs/contributors).
